...
const AddEditBlogPage = () => {
  ...
  const handleImageUpload = async (file) => {
    ...
    try {
      ...
      setThumbnail(mediaUrl); // Update thumbnail state with the uploaded image URL
      return mediaUrl; // Return the uploaded URL for later use
    } catch (error) {
  ...
  return (
    ...
    </Suspense> // Closing Suspense component here
  );
};
