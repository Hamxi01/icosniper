...
const LatestBlog = () => {
  return (
    <section>
      <h2 className="lg:text-4xl text-2xl font-semibold my-3">
        Latest Articles
      </h2>
      <div
        className="rounded-lg p-4 mb-4 grid lg:grid-cols-3 grid-cols-1 gap-8 bg-gray-300 dark:bg-gradient-to-br from-[#272535] to-[#11141b]"
        // style={{
        //   backgroundImage:
