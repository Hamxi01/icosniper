...
const Subscription = () => {
  return (
    <section className="lg:px-0 px-2">
      <div className="container mx-auto grid lg:grid-cols-2 grid-cols-1 gap-10 border-2 lg:py-16 py-10 lg:px-12 px-8 rounded-lg border-white/20 bg-gradient-to-tr from-[#223645] to-[#1f6193] w-full max-w-[1366px]">
        <div>
        ...
        <div>
          <form action="" className="w-full">
            <div className="flex w-full items-center space-x-2">
              ...
              <Button
                type="submit"
                className="dark:bg-[#2498d6] dark:text-white border-[#1f6193] border-2"
              >
                Subscribe
              </Button>
            </div>
